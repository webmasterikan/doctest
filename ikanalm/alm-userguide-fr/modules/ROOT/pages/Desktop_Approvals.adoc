...
[NOTE]
====
Les Approbations en attente que vous (ou un autre membre de votre Groupe d`'utilisateurs) pouvez accorder ou rejeter en ce moment sont précédées des icônes _Approuver__ et __ Rejeter_.
