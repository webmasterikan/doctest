...
. Cliquez sur le lien image:icons/lock.gif[,15,15] _Verrouiller_ ou image:images/icons/unlock.gif[,15,15] _ Déverrouiller_ dans le panneau __Aperçu des Branches__.
...
* Le lien image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _ Descendre_ pour modifier la séquence des Branches.
