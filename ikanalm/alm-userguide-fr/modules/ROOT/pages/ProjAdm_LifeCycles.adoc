...
. Utilisez les liens image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _ Descendre_ devant le Niveau pour modifier la position du Niveau sélectionné dans la séquence des Niveaux définis. 
+
