...
+
Verify this by clicking the image:images/icons/installed_phases.gif[,15,15] _ Installed
Phases_ link on the overview: you will be forwarded to the _Installed Phases Overview_ which displays a column for the __Current Server Activity __and one for the __Current Agent Activity, __which both should have a green image:images/icons/status_green.gif[,15,15]  icon as status.
If the icon is red image:images/icons/status_red.gif[,15,15] , verify the topic on how to _Start the IKAN ALM Agent/Server_ in the respective _Agent_ or __Server
...
image::images/Subversion_CreateRepository_01.png[,624,279] 
...
image::images/Subversion_CreateRepository_02.png[,579,634] 
...
image::images/CreateProject_Docgen.png[,1038,597] 
...
image::images/CreateLevel_BUILD.png[,473,445] 
...
You can check those Phases by selecting the image:images/icons/edit_phases.gif[,15,15] _ Edit
...
image::images/CreateEnvironment_build.png[,1030,268] 
...
They will be executed when the Build of a Level Request will be executed on the IKAN ALM Agent (see later). You can check those Phases by selecting the image:images/icons/edit_phases.gif[,15,15] _ Edit
...
image::images/Desktop.png[,1013,158] 

Click the image:images/icons/requestPlus.gif[,15,15] _ Request
icon_ in the _Action_ column of our Project Stream.


image::images/Create_BuildLevelRequest.png[,648,843] 
...
image::images/LevelRequestDetailedOverview.png[,970,593] 
...
image::images/Docgen_BUILD_zip.png[,1043,752] 
...
image::images/LevelRequestDetailedOverview_PhaseLogs_01.png[,945,454] 
...
image::images/LevelRequestDetailedOverview_ShowDetails.png[,904,336] 
...
image::images/Log_ExecuteScript.png[,1051,646] 
...
image::images/CreateLevel_TEST.png[,514,503] 
...
image::images/CreateEnvironment_deploy.png[,1057,267] 
...
On the __Parameters Overview__, click the image:images/icons/icon_createparameter.png[,15,15] _ Create
Parameter_ icon in front of the _TST_Tomcat_ Deploy Environment.


image::images/CreateDeployParameter.png[,807,586] 
...
image::images/Desktop_Deliver.png[,1012,224] 

Select the image:images/icons/icon_deliverBuild.png[,15,15] _ Deliver_ icon in the _Action_ Column of the Test Level to create the Deliver Level Request.


image::images/Create_DeliverLevelRequest.png[,977,726] 
...
image::images/Deliver_LevelRequestDetailedOverview.png[,1053,631] 
...
image::images/Deliver_LevelRequestDetailedOverview_Phaselogs_01.png[,918,446] 

Click the Deploy name (in our example: __Deploy
1 on machine ikan028__) to expand the information panel displaying the Phase details.


image::images/Deliver_LevelRequestDetailedOverview_Phaselogs_02.png[,913,266] 
...
image::images/Deliver_LevelRequestDetailedOverview_ShowDetails.png[,1055,603] 
...
Next, select the image:images/icons/edit_phases.gif[,15,15] _ Edit
...
Script_ Phases, by clicking the image:images/icons/remove.gif[,15,15] _ Remove_ icon on the __Phases Overview__.
...
image::images/Phases_03_InsertGenerateDocPhase.png[,1047,705] 
...
image::images/Phases_04_Result_PhasesOverview.png[,774,357] 

For the Phases to work correctly, we have to adapt some of the specific parameters.

Click the image:images/icons/icon_viewparameters.png[,15,15] _ View
Parameters_ icon in front of the Inserted Phases.

First we will adapt the parameters for the _Generate
Doc_ Phase (the first one for generating the HTML file): click the image:images/icons/edit.gif[,15,15] _ Edit_ link next to targetfile.name and set its value to index.
...
image::images/Phases_08_VerifyBuildLevelRequest.png[,906,383] 

Generate Doc (HTML): click the _Phase Parameters_ link to display the used parameters.


image::images/Phases_09_Log_PhaseParameters_generatedochtml.png[,901,486] 

Generate Simple War:


image::images/Phases_10_Log_PhaseParameters_generatesimplewar.png[,896,406] 
