...
* <<GlobAdm_ScriptingTools.adoc#_sglobadm_scriptingtool_ant,id==_sglobadm_scriptingtool_ant--title==ANT Scripting Tools>>
* <<GlobAdm_ScriptingTools.adoc#_sglobadm_scriptingtool_gradle,id==_sglobadm_scriptingtool_gradle--title==Gradle Scripting Tools>>
* <<GlobAdm_ScriptingTools.adoc#_sglobadm_scriptingtool_nant,id==_sglobadm_scriptingtool_nant--title==NANT Scripting Tools>>
* <<GlobAdm_ScriptingTools.adoc#_sglobad_scriptingtool_maven2,id==_sglobad_scriptingtool_maven2--title==Maven2 Scripting Tools>>
...
+
image::images/GlobAdm-ScriptingTools-Create.png[,599,270] 
+
...
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-Overview.png[,980,573] 
+
...
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-ANT-Create.png[,859,472] 
+
...
+
image::images/GlobAdm-ScriptingTools-ANT-Overview.png[,1017,487] 
+
...
. Verify the information on the _Scripting Tools Overview_ panel.
+
For a detailed description of the fields, refer to <<#_pcreateantscriptingtool,>>.
...
. Click the image:images/icons/edit.gif[,15,15] _Edit_ link to change the selected ANT Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-ANT-Edit.png[,1061,722] 
+
. Edit the fields as required.
+
For a description of the fields, refer to <<#_pcreateantscriptingtool,>>.
+
...
. Click the image:images/icons/delete.gif[,15,15]  _Delete_ link to delete the selected ANT Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-ANT-Delete.png[,1077,389] 
+
...
+
image::images/GlobAdm-ScriptingTools-ANT-Delete-Error.png[,831,518] 
+
...
. Click the image:images/icons/history.gif[,15,15] _History_ link to display the _ANT Scripting Tool History View_.
+
...
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-Gradle-Create.png[,859,383] 
+
...
+
image::images/GlobAdm-ScriptingTools-Gradle-Overview.png[,1021,309] 
+
If required, use the other search criteria to refine the items displayed on the overview.
+
The following options are available:
...
. Verify the information on the _Scripting Tools Overview_ panel.
+
For a detailed description of the fields, refer to <<#_poverviewgradlescriptingtool,>>.
...
. Click the image:images/icons/edit.gif[,15,15] _Edit_ link to change the selected Gradle Scripting Tool.
+
The following screen is displayed: 
+
image::images/GlobAdm-ScriptingTools-Gradle-Edit.png[,1061,625] 
+
. Edit the fields as required.
+
For a description of the fields, refer to <<#_pcreategradlescriptingtool,>>.
+
...
. Click the image:images/icons/delete.gif[,15,15]  _Delete_ link to delete the selected Gradle Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-Gradle-Delete.png[,758,307] 
+
...
+
image::images/GlobAdm-ScriptingTools-Gradle-Delete-Eror.png[,1002,572] 
+
...
. Click the image:images/icons/history.gif[,15,15] _History_ link to display the _Gradle Scripting Tool History View_.
+
For more detailed information concerning this __History
View__, refer to the section <<#_historyeventlogging,>>.
...
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-NANT-Create.png[,856,416] 
+
...
+
image::images/GlobAdm-ScriptingTools-NANT-Overview.png[,996,348] 
+
If required, use the other search criteria to refine the items displayed on the overview.
+
The following options are available:
...
. Verify the information on the _Scripting Tools Overview_ panel.
+
For a detailed description of the fields, refer to <<#_globadm_scriptingtool_nant_overview,>>.
...
. Click the image:images/icons/edit.gif[,15,15] _Edit_ link to change the selected NANT Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-NANT-Edit.png[,1026,537] 
+
. Edit the fields as required.
+
For a description of the fields, refer to <<#_pcreatenantscriptingtool,>>.
+
...
. Click the image:images/icons/delete.gif[,15,15]  _Delete_ link to delete the selected NANT Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-NANT-Delete.png[,584,319] 
+
...
+
image::images/GlobAdm-ScriptingTools-NANT-Delete-Error.png[,800,528] 
+
...
. Click the image:images/icons/history.gif[,15,15] _History_ link to display the _NANT Scripting Tool History View_.
+
For more detailed information concerning this __History
View__, refer to the section <<#_historyeventlogging,>>.
...
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-Maven2-Create.png[,851,387] 
+
...
Please refer to <<#_environmentparams_create,>>.
...
In that case you will be able to modify the value of the parameters at the moment of creating the level request. <<#_environmentparams_edit,>>
...
+
image::images/GlobAdm-ScriptingTools-Maven2-Overview.png[,870,273] 
+
If required, use the other search criteria to refine the items displayed on the overview.
+
The following options are available:
...
. Click the image:images/icons/edit.gif[,15,15] _Edit_ link to change the selected Maven2 Scripting Tool.
+
The following screen is displayed.
+
image::images/GlobAdm-ScriptingTools-Maven2-Edit.png[,1029,649] 
+
...
. Click the image:images/icons/delete.gif[,15,15]  _Delete_ link to delete the selected Maven2 Scripting Tool.
+
The following screen is displayed:
+
image::images/GlobAdm-ScriptingTools-Maven2-Delete.png[,605,287] 
+
. Click _Delete_ to confirm the deletion.
+
You can also click __Back __to return to the previous screen without deleting the entry.
...
+
image::images/GlobAdm-ScriptingTools-Maven2-Delete-Error.png[,790,510] 
+
...
. Click the image:images/icons/history.gif[,15,15] _History_ link to display the _Maven2 Scripting Tool History View_.
+
For more detailed information concerning this __History
View__, refer to the section <<#_historyeventlogging,>>.
