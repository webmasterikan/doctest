...
Refer to the section <<Desktop_Packages.adoc#_desktop_createpackage,id==_desktop_createpackage--title==Creating a Package>>for more in information.
...
* <<Desktop_Packages.adoc#_desktop_createpackage,id==_desktop_createpackage--title==Creating a Package>>
* <<Desktop_Packages.adoc#_desktop_packageoverview,id==_desktop_packageoverview--title==The Package Overview Screen>>
* <<#_desktop_viewpackage,>>
* <<#_desktop_editpackage,>>
* <<Desktop_Packages.adoc#_desktop_hideshowpackage,id==_desktop_hideshowpackage--title==Hiding/Showing a Package>>
...
For more information on adding File Revisions to the newly created Package, refer to the section <<Desktop_Packages.adoc#_desktop_packagedetails,id==_desktop_packagedetails--title==Package Details>>. 
...
|===
+
For more detailed information on the different tab pages, refer to the section <<Desktop_Packages.adoc#_desktop_packagedetails,id==_desktop_packagedetails--title==Package Details>>.
...
+
For a more detailed explanation on how to do that, refer to the section <<Desktop_Packages.adoc#_desktop_packagedetails_editcontents,id==_desktop_packagedetails_editcontents--title==Edit Contents>>
+
...
[NOTE]
====
If the__ Auto Refresh __option is activated, the screen will be refreshed each time the defined rate is expired. <<UserInterface.adoc#_desktop_autorefresh,id==_desktop_autorefresh--title==Auto Refresh>>
====
...
* <<Desktop_Packages.adoc#_desktop_packagedetails_summary,id==_desktop_packagedetails_summary--title==Summary>>
* <<Desktop_Packages.adoc#_desktop_packagedetails_viewcontents,id==_desktop_packagedetails_viewcontents--title==View Contents>>
* <<Desktop_Packages.adoc#_desktop_packagedetails_editcontents,id==_desktop_packagedetails_editcontents--title==Edit Contents>>
* <<Desktop_Packages.adoc#_desktop_packagedetails_lifecycleactions,id==_desktop_packagedetails_lifecycleactions--title==Lifecycle Actions>>
...
For more information on hiding Packages, refer to <<Desktop_Packages.adoc#_desktop_hideshowpackage,id==_desktop_hideshowpackage--title==Hiding/Showing a Package>>.
...
For more information on creating Level Requests, refer to the section <<Desktop_LevelRequests.adoc#_desktop_lr_creatinglevelrequest,id==_desktop_lr_creatinglevelrequest--title==Creating Level Requests>>.