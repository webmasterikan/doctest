...
Refer to the section <<_desktop_createpackage>>for more in information.
...
For more information on adding File Revisions to the newly created Package, refer to the section <<_desktop_packagedetails>>. 
...
|===
+
For more detailed information on the different tab pages, refer to the section <<_desktop_packagedetails>>.
...
+
For a more detailed explanation on how to do that, refer to the section <<_desktop_packagedetails_editcontents>>
+
...
[NOTE]
====
If the__ Auto Refresh __option is activated, the screen will be refreshed each time the defined rate is expired. <<_desktop_autorefresh>>
====
...
For more information on hiding Packages, refer to <<_desktop_hideshowpackage>>.
...
For more information on creating Level Requests, refer to the section <<_desktop_lr_creatinglevelrequest>>.