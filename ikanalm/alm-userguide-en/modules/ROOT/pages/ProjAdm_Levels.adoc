...
Before you can define Build or Deploy Environments, the required <<#_globadm_machines,>> and <<GlobAdm_ScriptingTools.adoc#_globadm_scriptingtools,id==_globadm_scriptingtools--title==Scripting Tools>> must have been defined.
...
** <<ProjAdm_Levels.adoc#_plevelenvmgt_editlevel,id==_plevelenvmgt_editlevel--title==Editing a Level>>
...
+
For more information on this panel, refer to <<ProjAdm_Levels.adoc#_levelenvmgt_overview,id==_levelenvmgt_overview--title==Levels Overview>>.
...
Lifecycle_ screen. <<ProjAdm_LifeCycles.adoc#_lifecycles_changingorderlevels,id==_lifecycles_changingorderlevels--title==Changing the order of the Levels>>
...
* image:images/icons/edit.gif[,15,15] <<ProjAdm_Levels.adoc#_plevelenvmgt_editlevel,id==_plevelenvmgt_editlevel--title==Editing a Level>>
* image:images/icons/delete.gif[,15,15] <<#_plevelenvmgt_deletelevel,>>
* image:images/icons/clone.gif[,15,15] <<#_plevelenvmgt_clonelevel,>>
* image:images/icons/edit_phases.gif[,15,15] <<ProjAdm_Levels.adoc#_levelenvmgt_levelphases,id==_levelenvmgt_levelphases--title==Level Phases>>
...
When executing a Level Request for this Level, a log will be created for each of the Phases. <<Desktop_LevelRequests.adoc#_dekstop_lr_detailedoverview,id==_dekstop_lr_detailedoverview--title==Level Request Detail>>
