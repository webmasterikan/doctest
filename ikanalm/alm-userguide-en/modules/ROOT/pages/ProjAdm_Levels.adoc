...
Before you can define Build or Deploy Environments, the required <<#_globadm_machines,>> and <<GlobAdm_ScriptingTools.adoc#_globadm_scriptingtools,Scripting>> must have been defined.
...
** <<ProjAdm_Levels.adoc#_plevelenvmgt_editlevel,Editing>>
...
+
For more information on this panel, refer to <<ProjAdm_Levels.adoc#_levelenvmgt_overview,Levels>>.
...
Lifecycle_ screen. <<ProjAdm_LifeCycles.adoc#_lifecycles_changingorderlevels,Changing>>
...
* image:images/icons/edit.gif[,15,15] <<ProjAdm_Levels.adoc#_plevelenvmgt_editlevel,Editing>>
* image:images/icons/delete.gif[,15,15] <<#_plevelenvmgt_deletelevel,>>
* image:images/icons/clone.gif[,15,15] <<#_plevelenvmgt_clonelevel,>>
* image:images/icons/edit_phases.gif[,15,15] <<ProjAdm_Levels.adoc#_levelenvmgt_levelphases,Level>>
...
When executing a Level Request for this Level, a log will be created for each of the Phases. <<Desktop_LevelRequests.adoc#_dekstop_lr_detailedoverview,Level>>
