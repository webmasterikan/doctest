...
* <<ProjAdm_BuildEnv.adoc#_buildenvironmentsoverview,id==_buildenvironmentsoverview--title==The Build Environments Overview Screen>>
+
...
** <<ProjAdm_BuildEnv.adoc#_projadm_buildenv_historyview,id==_projadm_buildenv_historyview--title==Viewing the Build Environment History>>
* Build Parameters
+
...
====
+
For more information on the available links, refer to <<ProjAdm_BuildEnv.adoc#_buildenvironmentsoverview,id==_buildenvironmentsoverview--title==The Build Environments Overview Screen>>.
...
When executing a Build for this Environment, a log will be created for each of the Phases. <<Desktop_LevelRequests.adoc#_dekstop_lr_detailedoverview,id==_dekstop_lr_detailedoverview--title==Level Request Detail>>
...
* <<ProjAdm_BuildEnv.adoc#_projadm_buildenv_phasedelete,id==_projadm_buildenv_phasedelete--title==Deleting a Build Environment Phase>>
...
* The image:images/icons/delete.gif[,15,15] _Delete_ link to delete a Phase. <<ProjAdm_BuildEnv.adoc#_projadm_buildenv_phasedelete,id==_projadm_buildenv_phasedelete--title==Deleting a Build Environment Phase>>
