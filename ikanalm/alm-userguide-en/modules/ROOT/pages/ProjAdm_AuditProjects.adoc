...
+
For the list of possible error and warning messages, refer to the section <<ProjAdm_AuditProjects.adoc#_projadm_auditingprojects_errorswarnings,Auditing>>.
...
** <<ProjAdm_AuditProjects.adoc#_babgjghf,Error>>
** <<ProjAdm_AuditProjects.adoc#_babcfbhf,Warning>>
