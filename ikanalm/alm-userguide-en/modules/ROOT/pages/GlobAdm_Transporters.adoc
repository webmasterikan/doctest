...
The relative locations for all remote transporters must be defined in the _System Settings_ section. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
* <<GlobAdm_Transporters.adoc#_globadm_transporter_filecopy,FileCopy>>
* <<GlobAdm_Transporters.adoc#_globadm_transporter_ftp,FTP>>
* <<GlobAdm_Transporters.adoc#_globadm_transporter_secureshell,Secure>>
...
FileCopy Locations_ and can only be updated in the System Settings section. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
|Enter the prefix for the Build Archive Location (the location where the Builds are stored or retrieved from by an IKAN ALM Agent handling a Build or Deploy process). The Server Location will be formed by concatenating this prefix together with the Relative Location defined in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
The Server Location will be formed by concatenating this prefix together with the Relative Location defined in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
* <<GlobAdm_System.adoc#_globadm_system_settings,System>>
* <<#_globadm_machines,>>
...
_Note:_ The value entered in this field will override the value specified in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>If not specified in the System Settings nor on this screen, the default FTP Port Number `21` will be used.
...
|Build Archive Path Prefix
|Enter the prefix for the Build Archive Location (the location where the Builds are stored or retrieved from). The Server Location will be formed by concatenating this prefix together with the Relative Location defined in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
|Script Path Prefix
|Enter the prefix for the Script Location (the location where the IKAN ALM Agent will retrieve the build or deploy script from if it cannot be found in the sources). The Server Location will be formed by concatenating this prefix together with the Relative Location defined in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
_Note:_ The value entered in this field will overrule the value specified in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>If not specified in the System Settings nor on this screen, the default SSH Port Number `22` will be used.
