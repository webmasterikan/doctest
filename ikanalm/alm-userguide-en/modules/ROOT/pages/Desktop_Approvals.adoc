...
* image:images/icons/approve.gif[,15,15] __ Approve__. <<_desktop_outstandingapprovalsapprove>>
* image:images/icons/reject.gif[,15,15] __ Reject__. <<_desktop_outstandingapprovalsreject>>
...
. Verify the information on the _Level Approval List_ panel.
+
The _Level Approval List_ displays additional information concerning the Approvals. <<_desktop_outstandingapprovalsapprove>>
...
For more information, refer to <<_desktop_outstandingapprovalsapprove>>and <<_desktop_outstandingapprovalsreject>>.
====
+
...
The format of the VCR Tag normally matches the Tag Template defined for the Stream. <<_projectstreams_overviewscreen>>
