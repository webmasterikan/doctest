...
* <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsscreen,Approvals>>
* <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsapprove,Approving>>
* <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsreject,Rejecting>>
...
* image:images/icons/approve.gif[,15,15] __ Approve__. <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsapprove,Approving>>
* image:images/icons/reject.gif[,15,15] __ Reject__. <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsreject,Rejecting>>
...
. Verify the information on the _Level Approval List_ panel.
+
The _Level Approval List_ displays additional information concerning the Approvals. <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsapprove,Approving>>
...
For more information, refer to <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsapprove,Approving>>and <<Desktop_Approvals.adoc#_desktop_outstandingapprovalsreject,Rejecting>>.
====
+
...
The format of the VCR Tag normally matches the Tag Template defined for the Stream. <<ProjAdm_ProjMgt_ProjectStream.adoc#_projectstreams_overviewscreen,Project>>
