...
* <<App_Phases.adoc#_phases_levelphases,Level>>: phases inserted into the Level workflow. They will be executed on the IKAN ALM Server.
* <<App_Phases.adoc#_phases_buildphases,Build>>: phases inserted into the Build Environment workflow. They will be executed on an IKAN ALM Agent.
* <<App_Phases.adoc#_phases_deployphases,Deploy>>: phases inserted into the Deploy Environment workflow. They will be executed on an IKAN ALM Agent.
...
The execution of a Phase can be viewed on the <<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs,Phase>> tab page on the _Level Request Detail_ screen.
...
Level Phases may be inserted into the workflow of a Level (<<ProjAdm_Levels.adoc#_levelenvmgt_levelphases,Level>>) and are logged on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_levelphases,Level>>).
...
* <<App_Phases.adoc#_phases_levelphases_retrievecode,Retrieve>>
* <<App_Phases.adoc#_phases_levelphases_build,Build>>
* <<App_Phases.adoc#_phases_levelphases_tagcode,Tag>>
* <<App_Phases.adoc#_phases_levelphases_deploy,Deploy>>
* <<App_Phases.adoc#_phases_levelphases_issuetracking,Issue>>
* <<App_Phases.adoc#_phases_levelphases_linkfilerevisions,Link>>
* <<App_Phases.adoc#_phases_levelphases_cleanupworkcopy,Cleanup>>
* <<App_Phases.adoc#_phases_levelphases_executescriptphase,Execute>>


Next to the Core Level Phases, you can create your own Custom Level Phases:

* <<App_Phases.adoc#_phases_levelphases_customlevelphase,Custom>>
...
See <<Desktop_LevelRequests.adoc#_desktop_lr_viewdependency,Build>>.
...
Build Phases may be inserted into a Build Environment (<<ProjAdm_BuildEnv.adoc#_projadm_buildenv_phases,Build>>). Their actions during the handling of a Build are logged on the _Phase
Logs_ tab page of the _Level Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_buildactions,Build>>). 
...
* <<App_Phases.adoc#_babfgbhf,Transport>>
* <<App_Phases.adoc#_babcijhh,Verify>>
* <<App_Phases.adoc#_phases_buildphases_executebuildscript,Execute>>
* <<App_Phases.adoc#_phases_buildphases_transportdesployscript,Transport>>
* <<App_Phases.adoc#_phases_buildphases_transportpackagerersults,Transport>>
* <<App_Phases.adoc#_phases_buildphases_compressbuild,Compress>>
* <<App_Phases.adoc#_phases_buildphases_archiveresult,Archive>>
* <<App_Phases.adoc#_phases_buildphases_cleanupsource,Cleanup>>
* <<App_Phases.adoc#_phases_buildphases_cleanupresult,Cleanup>>


Next to the Core Build Phases, you can create your own Custom Build Phases:

* <<App_Phases.adoc#_phases_buildphases_custombuildphase,Custom>>
...
See also <<App_Phases.adoc#_phases_levelphases_retrievecode,Retrieve>>.
...
If not found, it tries to copy the Build Script from the IKAN ALM Script Location as defined in the System Settings (<<GlobAdm_System.adoc#_globadm_system_settings,System>>).
...
Script_ Phase exits with status __Success__.
If not, it exits with status _Error_ and logs the errors on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_buildactions,Build>>).
...
Deploy Phases may be inserted into a Deploy Environment (<<ProjAdm_DeployEnv.adoc#_projadm_deplanv_phases,Deploy>>) and their actions during the handling or a Deploy are logged on the _Phase
Logs_ tab page of the _Level Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_deployactions,Deploy>>). 
...
* <<App_Phases.adoc#_phases_deployphases_transportbuildresult,Transport>>
* <<App_Phases.adoc#_phases_deployphases_decompressbuildresult,Decompress>>
* <<App_Phases.adoc#_phases_deployphases_verifydeployscript,Verify>>
* <<App_Phases.adoc#_phases_deployphases_executedeployscript,Execute>>
* <<App_Phases.adoc#_phases_deployphases_cleanupbuidlresult,Cleanup>>


Next to the Core Deploy Phases, you can create your own Custom Deploy Phases:

* <<App_Phases.adoc#_phases_deployphases_customdeployphase,Custom>>
...
If not found, it tries to copy the Deploy Script from the IKAN ALM Script Location as defined in the System Settings (<<GlobAdm_System.adoc#_globadm_system_settings,System>>).
...
Script_ Phase exits with status __Success__.
If not, it exits with status _Error_ and logs the errors on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_deployactions,Deploy>>).
