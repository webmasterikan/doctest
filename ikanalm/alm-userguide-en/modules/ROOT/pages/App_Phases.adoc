...
* <<App_Phases.adoc#_phases_levelphases,id==_phases_levelphases--title==Level Phases>>: phases inserted into the Level workflow. They will be executed on the IKAN ALM Server.
* <<App_Phases.adoc#_phases_buildphases,id==_phases_buildphases--title==Build Phases>>: phases inserted into the Build Environment workflow. They will be executed on an IKAN ALM Agent.
* <<App_Phases.adoc#_phases_deployphases,id==_phases_deployphases--title==Deploy Phases>>: phases inserted into the Deploy Environment workflow. They will be executed on an IKAN ALM Agent.
...
The version of Custom Phases conforms to the format as explained in the section <<GlobAdm_Phases.adoc#_globadm_phases_creating,id==_globadm_phases_creating--title==Phases>>.
...
For more information on defining and configuring Phases, refer to the following sections: <<#_plevelenvmgt_editlevelphases,>>, <<#_projadm_buildenv_editphase,>>, <<#_projadm_deployenv_phaseedit,>>, <<GlobAdm_Phases.adoc#_globadm_phases_creating,id==_globadm_phases_creating--title==Phases>>and <<#_globadm_phases_editing,>>.
...
The execution of a Phase can be viewed on the <<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs,id==_desktop_lr_phaselogs--title==Phase Logs>> tab page on the _Level Request Detail_ screen.
...
Level Phases may be inserted into the workflow of a Level (<<ProjAdm_Levels.adoc#_levelenvmgt_levelphases,id==_levelenvmgt_levelphases--title==Level Phases>>) and are logged on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_levelphases,id==_desktop_lr_phaselogs_levelphases--title==Level Phases>>).
...
* <<App_Phases.adoc#_phases_levelphases_retrievecode,id==_phases_levelphases_retrievecode--title==Retrieve Code Phase>>
* <<App_Phases.adoc#_phases_levelphases_build,id==_phases_levelphases_build--title==Build Phase>>
* <<App_Phases.adoc#_phases_levelphases_tagcode,id==_phases_levelphases_tagcode--title==Tag Code Phase>>
* <<App_Phases.adoc#_phases_levelphases_deploy,id==_phases_levelphases_deploy--title==Deploy Phase>>
* <<App_Phases.adoc#_phases_levelphases_issuetracking,id==_phases_levelphases_issuetracking--title==Issue Tracking Phase>>
* <<App_Phases.adoc#_phases_levelphases_linkfilerevisions,id==_phases_levelphases_linkfilerevisions--title==Link File Revisions>>
* <<App_Phases.adoc#_phases_levelphases_cleanupworkcopy,id==_phases_levelphases_cleanupworkcopy--title==Cleanup Work Copy Phase>>
* <<App_Phases.adoc#_phases_levelphases_executescriptphase,id==_phases_levelphases_executescriptphase--title==Execute Script Phase>>


Next to the Core Level Phases, you can create your own Custom Level Phases:

* <<App_Phases.adoc#_phases_levelphases_customlevelphase,id==_phases_levelphases_customlevelphase--title==Custom Level Phase>>
...
See <<Desktop_LevelRequests.adoc#_desktop_lr_viewdependency,id==_desktop_lr_viewdependency--title==Build Dependencies>>.
...
In the case of a Build Level Request, the Issue Tracking Phase parses the commit comments that have been entered since the last successful Level Request for that Level and tries to match the Issue Pattern of the attached Issue Tracking System (<<GlobAdm_IssueTracking.adoc#_globadm_issuetrackingcreate,id==_globadm_issuetrackingcreate--title==Issue Tracking id==_globadm_issuetrackingcreate--title==Creating an Issue Tracking System>>). All found Issues will be attached to the Level Request.
...
Next to the Core Phases, you may define your own Phases in Global Administration (<<GlobAdm_Phases.adoc#_globadm_phases_creating,id==_globadm_phases_creating--title==Phases>>) and specify that they may be used on a Level.
...
Build Phases may be inserted into a Build Environment (<<ProjAdm_BuildEnv.adoc#_projadm_buildenv_phases,id==_projadm_buildenv_phases--title==Build Environment Phases>>). Their actions during the handling of a Build are logged on the _Phase
Logs_ tab page of the _Level Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_buildactions,id==_desktop_lr_phaselogs_buildactions--title==Build Actions>>). 
...
* <<App_Phases.adoc#_babfgbhf,id==_babfgbhf--title==Transport Source Phase>>
* <<App_Phases.adoc#_babcijhh,id==_babcijhh--title==Verify Build Script Phase>>
* <<App_Phases.adoc#_phases_buildphases_executebuildscript,id==_phases_buildphases_executebuildscript--title==Execute Script Phase>>
* <<App_Phases.adoc#_phases_buildphases_transportdesployscript,id==_phases_buildphases_transportdesployscript--title==Transport Deploy Script Phase>>
* <<App_Phases.adoc#_phases_buildphases_transportpackagerersults,id==_phases_buildphases_transportpackagerersults--title==Transport Package Results Phase>>
* <<App_Phases.adoc#_phases_buildphases_compressbuild,id==_phases_buildphases_compressbuild--title==Compress Build Phase>>
* <<App_Phases.adoc#_phases_buildphases_archiveresult,id==_phases_buildphases_archiveresult--title==Archive Result Phase>>
* <<App_Phases.adoc#_phases_buildphases_cleanupsource,id==_phases_buildphases_cleanupsource--title==Cleanup Source Phase>>
* <<App_Phases.adoc#_phases_buildphases_cleanupresult,id==_phases_buildphases_cleanupresult--title==Cleanup Result Phase>>


Next to the Core Build Phases, you can create your own Custom Build Phases:

* <<App_Phases.adoc#_phases_buildphases_custombuildphase,id==_phases_buildphases_custombuildphase--title==Custom Build Phase>>
...
See also <<App_Phases.adoc#_phases_levelphases_retrievecode,id==_phases_levelphases_retrievecode--title==Retrieve Code Phase>>.
...
If not found, it tries to copy the Build Script from the IKAN ALM Script Location as defined in the System Settings (<<GlobAdm_System.adoc#_globadm_system_settings,id==_globadm_system_settings--title==System id==_globadm_system_settings--title==System Settings>>).
...
Script_ Phase exits with status __Success__.
If not, it exits with status _Error_ and logs the errors on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_buildactions,id==_desktop_lr_phaselogs_buildactions--title==Build Actions>>).
...
Next to the Core Phases, you may define your own Phases in Global Administration (<<GlobAdm_Phases.adoc#_globadm_phases_creating,id==_globadm_phases_creating--title==Phases>>) and specify that they may be used on a Build Environment.
...
Deploy Phases may be inserted into a Deploy Environment (<<ProjAdm_DeployEnv.adoc#_projadm_deplanv_phases,id==_projadm_deplanv_phases--title==Deploy Environment Phases>>) and their actions during the handling or a Deploy are logged on the _Phase
Logs_ tab page of the _Level Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_deployactions,id==_desktop_lr_phaselogs_deployactions--title==Deploy Actions>>). 
...
* <<App_Phases.adoc#_phases_deployphases_transportbuildresult,id==_phases_deployphases_transportbuildresult--title==Transport Build Result Phase>>
* <<App_Phases.adoc#_phases_deployphases_decompressbuildresult,id==_phases_deployphases_decompressbuildresult--title==Decompress Build Result Phase>>
* <<App_Phases.adoc#_phases_deployphases_verifydeployscript,id==_phases_deployphases_verifydeployscript--title==Verify Deploy Script Phase>>
* <<App_Phases.adoc#_phases_deployphases_executedeployscript,id==_phases_deployphases_executedeployscript--title==Execute Script Phase>>
* <<App_Phases.adoc#_phases_deployphases_cleanupbuidlresult,id==_phases_deployphases_cleanupbuidlresult--title==Cleanup Build Result Phase>>


Next to the Core Deploy Phases, you can create your own Custom Deploy Phases:

* <<App_Phases.adoc#_phases_deployphases_customdeployphase,id==_phases_deployphases_customdeployphase--title==Custom Deploy Phase>>
...
If not found, it tries to copy the Deploy Script from the IKAN ALM Script Location as defined in the System Settings (<<GlobAdm_System.adoc#_globadm_system_settings,id==_globadm_system_settings--title==System id==_globadm_system_settings--title==System Settings>>).
...
Script_ Phase exits with status __Success__.
If not, it exits with status _Error_ and logs the errors on the _Phase Logs_ panel of the _Level
Request Detail_ screen (<<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs_deployactions,id==_desktop_lr_phaselogs_deployactions--title==Deploy Actions>>).
...
Next to Core Phases, you may define your own Phases in Global Administration (<<GlobAdm_Phases.adoc#_globadm_phases_creating,id==_globadm_phases_creating--title==Phases>>) and specify that they may be used on a Deploy Environment.
