...
* <<UserInterface.adoc#_navigationikanalm,Navigating>>
* <<UserInterface.adoc#_regularikanalmscreens,The>>
...
For more info on using filters, refer to the section <<Desktop_PersonalSettings.adoc#_desktop_searchfilters,Defining>>.
...
If your IKAN ALM Global Manager has defined an _Automatic Refresh Rate_ on the _Miscellaneous_ panel in the <<GlobAdm_System.adoc#_globadm_system_settings,System>>, the _Auto Refresh_ option will be available on the Desktop, and on the Level Requests and Builds and Deploys overviews.
