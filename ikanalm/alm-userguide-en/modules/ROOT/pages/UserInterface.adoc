...
* <<UserInterface.adoc#_navigationikanalm,id==_navigationikanalm--title==Navigating Through IKAN ALM>>
* <<UserInterface.adoc#_regularikanalmscreens,id==_regularikanalmscreens--title==The IKAN ALM Screen>>
...
image::images/UserInterface_MainMenu_Sections.png[,1041,332] 
...
image::images/UserInterface_MainMenu_Navigating.png[,1054,378] 
...
image::images/UserInterface-Screens.png[,1015,434] 
...
image::images/UserInterface-SearchPanel.png[,965,156] 
...
For more info on using filters, refer to the section <<Desktop_PersonalSettings.adoc#_desktop_searchfilters,id==_desktop_searchfilters--title==Defining Search Filters>>.


==== Create Panels
image::images/UserInterface-CreatePanel.png[,490,266] 
...
|image:images/icons/view.gif[,15,15]  View
...
|image:images/icons/history.gif[,15,15]  History
...
|image:images/icons/status.gif[,15,15]  Status
...
|image:images/icons/edit.gif[,15,15]  Edit
...
|image:images/icons/delete.gif[,15,15]  Delete
...
|image:images/icons/lock.gif[,15,15]  Lock

image:images/icons/unlock.gif[,15,15]  Unlock
|This option is specific for the _Project_ panel and the _Project
Streams Overview_ panel.

|image:images/icons/hide.gif[,15,15]  Hide

image:images/icons/show.gif[,15,15]  Show
...
|image:images/icons/optional.gif[,15,15]  Set Optional

image:images/icons/required.gif[,15,15]  Set Required
|These options are specific for the _Lifecycles Overview_ screen.

They allow you to make Levels optional. 

|image:images/icons/icon_editProperties.png[,15,15]  Edit Properties
...
|image:images/icons/icon_disconnectUser.png[,15,15]  Disconnect User
...
If your IKAN ALM Global Manager has defined an _Automatic Refresh Rate_ on the _Miscellaneous_ panel in the <<GlobAdm_System.adoc#_globadm_system_settings,id==_globadm_system_settings--title==System id==_globadm_system_settings--title==System Settings>>, the _Auto Refresh_ option will be available on the Desktop, and on the Level Requests and Builds and Deploys overviews.
...
image::images/Desktop-AutoRefresh-SubmenuOption.png[,1015,400] 
