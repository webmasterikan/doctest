...
For more info on using filters, refer to the section <<_desktop_searchfilters>>.
...
If your IKAN ALM Global Manager has defined an _Automatic Refresh Rate_ on the _Miscellaneous_ panel in the <<_globadm_system_settings>>, the _Auto Refresh_ option will be available on the Desktop, and on the Level Requests and Builds and Deploys overviews.
