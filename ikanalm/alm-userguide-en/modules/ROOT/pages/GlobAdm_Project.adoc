...
+
image::images/GlobAdmin-Project-Create.png[,1027,707] 
+
...
For more information on Issue Tracking systems, refer to the chapter <<#_globadm_issuetracking,>>
...
Settings_ dialog. <<GlobAdm_System.adoc#_globadm_system_settings,id==_globadm_system_settings--title==System id==_globadm_system_settings--title==System Settings>>
...
Settings__ dialog. <<GlobAdm_System.adoc#_globadm_system_settings,id==_globadm_system_settings--title==System id==_globadm_system_settings--title==System Settings>>
|===
...
+
image::images/GlobAdmin-Project-Create-ErrorProjName.png[,736,520] 
+
...
For more information, refer to the section <<#_projadmin_projectsoverview_editing,>>.
+
image::images/GlobAdmin-Project-Create-EditProject.png[,602,850] 
+
...
The following screen is displayed:
+
image::images/GlobAdmin-Project-Clone.png[,888,428] 
+
...
. Next, click the image:images/icons/clone.gif[,15,15] _clone_ link in front of the required Project.
+
The following screen is displayed:
+
image::images/GlobAdmin-Project-Clone-Clone.png[,812,538] 
+
