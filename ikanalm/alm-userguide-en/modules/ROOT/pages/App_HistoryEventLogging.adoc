...
To display the History Log of those operations, you can use the image:images/icons/history.gif[,15,15]  icon (or image:images/icons/history.gif[,15,15] _History_ link) which is available on all _Overview_ screens as well as on some of the edit screens, like the _System
...
+
image::images/History_OverviewScreen.png[,1010,352] 
+
. Click the image:images/icons/history.gif[,15,15] _History_ link, underneath the __Overview__, to display the _History View_ screen.
+
...
+
image::images/History_Versions.png[,595,623] 
+
...
+
image::images/History_Differences.png[,941,718] 
+
...
image::images/History_Differences-UserGroupUserAssociation.png[,959,641] 
...
image::images/History_Differences-PackagesModifiedFiles.png[,1026,541] 
