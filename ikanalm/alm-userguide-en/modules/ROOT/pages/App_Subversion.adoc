...
* <<App_Subversion.adoc#_sappc_repositoryconnection,Repository>>
* <<App_Subversion.adoc#_sappc_repositorydefinition,Repository>>
* <<App_Subversion.adoc#_sappc_fetchmetaproperties,Fetching>>
...
* <<App_Subversion.adoc#_sappc_specificfields,Specific>>
* <<App_Subversion.adoc#_sappc_layoutexamples,Layout>>
...
See the <<App_Subversion.adoc#_sappc_layoutexamples,Layout>> for the configuration of the 4 possible Layouts.
