...
For more information, refer to the sections <<_phases_levelphases_issuetracking>>and <<_levelenvmgt_levelphases>>.
...
Refer to the section <<_globadm_issuetrackingproperties_overview>> for editing the Issue Tracking System properties.
+
...
+
For a detailed description of the fields, refer to <<_globadm_issuetrackingcreate>>.
...
+
For a description of the fields, refer to <<_globadm_issuetrackingcreate>>.
+
...
+
For more information, refer to the section <<_globadm_issuetrackingproperties_overview>>
...
+
For a description of the fields, refer to the section <<_globadm_issuetrackingproperties_create>>.
