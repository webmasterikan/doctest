...
|alm.build.filename
|This parameter provides the name of the Build File that will be stored in the Build Archive Location. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
