...
** <<ProjAdm_LifeCycles.adoc#_plifecyclemgt_editlifecycle,Editing>>
** <<#_plifecyclemgt_deletelifecycle,>>
* Modifying the contents of a Lifecycle
** <<ProjAdm_LifeCycles.adoc#_lifecycles_creatingadditionallevels,Creating>>
** <<ProjAdm_LifeCycles.adoc#_lifecycles_insertingexistinglevel,Inserting>>
** <<ProjAdm_LifeCycles.adoc#_lifecycles_changingorderlevels,Changing>>
** <<ProjAdm_LifeCycles.adoc#_lifecycles_makingoptional,Making>>
...
+
For more information on this panel, refer to <<ProjAdm_LifeCycles.adoc#_lifecyclemgt_screen,Lifecycles>>.
...
+
For more information, refer to the section <<ProjAdm_LifeCycles.adoc#_plifecyclemgt_editlifecycle,Editing>>.
...
* <<ProjAdm_LifeCycles.adoc#_lifecycles_definedlevels,Defined>>
* <<ProjAdm_LifeCycles.adoc#_lifecycles_creatingadditionallevels,Creating>>
* <<ProjAdm_LifeCycles.adoc#_lifecycles_insertingexistinglevel,Inserting>>
* <<ProjAdm_LifeCycles.adoc#_lifecycles_changingorderlevels,Changing>>
* <<ProjAdm_LifeCycles.adoc#_lifecycles_makingoptional,Making>>
...
[NOTE]
====
In case Deploys are skipped, the status of the Level Request will be set to warning (even if it executed successfully). See also <<Desktop_LevelRequests.adoc#_desktop_lr_phaselogs,Phase>>.
====
. Switch to the _Lifecycles Overview_ screen.
+
<<#_plifecyclemgt_screen,>>
