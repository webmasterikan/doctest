...
[NOTE]
====
The icon image:images/icons/icon_MachineParameter.png[,15,15]  indicates that the parameter is a Machine Parameter. <<GlobAdm_Machines.adoc#_globadm_machineparameters,Machine>> In order to show these Parameters, you should set the _Show
