...
== History Log (((History Log)))  (((Global Administration ,History Log))) 
...
+
image::images/GlobAdm-HistoryLog-Screen.png[,971,788] 
+
...
+
image::images/GlobAdm-HistoryLog-Comparison.png[,934,652] 
+
...
+
image::images/GlobAdm-HistoryLog-Comparison2.png[,758,598] 
