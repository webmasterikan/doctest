...
** <<Desktop_ManageDesktop.adoc#_managedesktop_removingtabpage,id==_managedesktop_removingtabpage--title==Removing a Desktop Tab Page>>
* Managing the Desktop content
** <<#_managedesktop_addingelements,>>
** <<Desktop_ManageDesktop.adoc#_managedesktop_arrangingelements,id==_managedesktop_arrangingelements--title==Rearranging Desktop Elements>>
** <<Desktop_ManageDesktop.adoc#_managedesktop_removingelements,id==_managedesktop_removingelements--title==Removing Desktop Elements>>
...
[NOTE]
====
If the__ Auto Refresh __option is activated, the Desktop will be refreshed each time the defined rate is expired. <<UserInterface.adoc#_desktop_autorefresh,id==_desktop_autorefresh--title==Auto Refresh>>
====
