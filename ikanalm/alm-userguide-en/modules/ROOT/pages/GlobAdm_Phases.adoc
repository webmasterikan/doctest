...
[NOTE]
====
The location of the Phase Catalog is specified in the System Settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
====
+
...
* <<ProjAdm_Levels.adoc#_levelenvmgt_levelphases,Level>>
* <<#_plevelenvmgt_insertphase,>>
* <<ProjAdm_BuildEnv.adoc#_projadm_buildenv_phases,Build>>
* <<ProjAdm_DeployEnv.adoc#_projadm_deplanv_phases,Deploy>>
* Phase Catalog settings. <<GlobAdm_System.adoc#_globadm_system_settings,System>>
...
+
Meanwhile, IKAN ALM re-packages the uploaded files in a .jar file and replaces the existing .jar file in the Phase Catalog location (as defined in the System Settings (<<GlobAdm_System.adoc#_globadm_system_settings,System>>) with the new .jar file.
...
The scripts and other files contained within the Phase are packaged into a .jar file and copied to the Phase Catalog location (as defined in the <<GlobAdm_System.adoc#_globadm_system_settings,System>>).
+
