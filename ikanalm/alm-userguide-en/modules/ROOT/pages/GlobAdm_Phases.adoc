...
[NOTE]
====
The location of the Phase Catalog is specified in the System Settings. <<_globadm_system_settings>>
====
+
...
* Phase Catalog settings. <<_globadm_system_settings>>
...
+
For a detailed description of the fields, refer to <<_globadm_phases_creating>>and <<_globadm_phases_editing>>.
...
+
For a description of the fields, refer to <<_globadm_phases_creating>>.
+
...
====
+
For more information on uploading files, refer to the section <<_globadm_phases_creating>>.
...
+
Meanwhile, IKAN ALM re-packages the uploaded files in a .jar file and replaces the existing .jar file in the Phase Catalog location (as defined in the System Settings (<<_globadm_system_settings>>) with the new .jar file.
...
+
For a description of the fields, refer to the section <<_globadm_phases_creating>>.
+
...
For a description of the fields, refer to the sections <<_globadm_phases_creating>>and <<_globadm_phases_editing>>.
+
...
The scripts and other files contained within the Phase are packaged into a .jar file and copied to the Phase Catalog location (as defined in the <<_globadm_system_settings>>).
+
