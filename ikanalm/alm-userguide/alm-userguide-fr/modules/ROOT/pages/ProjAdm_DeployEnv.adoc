...
. Utilisez les liens image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _Descendre_ devant la Phase d'Environnement de déploiement pour modifier la position de la Phase sélectionnée dans la séquence.
