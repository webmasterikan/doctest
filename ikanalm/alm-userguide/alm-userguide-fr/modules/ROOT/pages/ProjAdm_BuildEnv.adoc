...
* Les liens image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _Descendre_ pour modifier l`'ordre des Phases.
...
<<ProjAdm_BuildEnv.adoc#_buildenvironmentsoverview,Aperçu des environnements de construction>>
 ...
 . Utilisez les liens image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _Descendre_ devant la Phase d'Environnement de construction pour modifier la position de la Phase sélectionnée dans la séquence.
