...
Vous pouvez toujours modifier la séquence des Niveaux en utilisant les options image:icons/up.gif[,15,15] _Monter_ ou image:images/icons/down.gif[,15,15] _Descendre_ dans le panneau _Niveaux associés_ dans l'écran __Modifier
...
* Le lien image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _Descendre_ pour modifier la séquence des Phases. <<ProjAdm_Levels.adoc#_plevelenvmgt_modifyorderphases,Modifier la séquence des Phases de niveau>>
...
. Utilisez les liens image:icons/up.gif[,15,15] _Monter_ et image:images/icons/down.gif[,15,15] _Descendre_ devant la Phase de niveau pour modifier la position de la Phase sélectionnée dans la séquence. 
...
. Pour y accéder, cliquez sur le lien image:icons/icon_preApproval.png[,15,15] _Ajouter une Pré-approbation_ ou image:images/icons/icon_postApproval.png[,15,15] _Ajouter une Post-approbation_ en bas de l'écran __Modifier un Niveau__.
+
